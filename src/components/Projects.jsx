  ...
  const projects = [
    {
      ...
      description: "Modern portfolio website built with React.js and Tailwind CSS featuring smooth animations, dark/light mode toggle, and responsive design optimized for all devices",
    ...
    {
      title: "InfiniteCode",
      description: "AI-powered Integrated Development Environment with intelligent code generation, smart auto-complete, and advanced debugging features for enhanced productivity",
    ...
    },
    {
      ...
      description: "Modern restaurant website featuring interactive menu displays, special offers showcase, customer testimonials, and seamless user experience with React and CSS Modules",
      ...
      <div className="container-custom">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground mt-6 max-w-2xl mx-auto">
            Showcasing innovative AI & ML solutions built with modern technologies and best practices
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {projects.map((project, index) => (
            ...
            >
              <div className={`h-2 w-full rounded-t-xl bg-gradient-to-r ${project.gradient} mb-6`}></div>
