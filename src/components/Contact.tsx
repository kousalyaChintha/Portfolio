            ...
            <div className="space-y-8 animate-slide-in-left">
              <div>
                ...
                <p className="text-muted-foreground mb-8 leading-relaxed">
                  I'm always excited to discuss AI & ML opportunities, data
                  science projects, or collaborate on innovative technology
                  solutions.
                </p>
              </div>
              ...
              <div className="space-y-6">
                ...
                <div className="card-glass flex items-center p-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">+91 9494183516</p>
                  </div>
                </div>
              </div>

              <div className="card-glass p-6">
                <h4 className="font-semibold text-neon-cyan mb-4">
